...
export interface PayrollEntryItemTypeEntityEvent {
...
export interface PayrollEntryItemTypeUpdateEntityEvent extends PayrollEntryItemTypeEntityEvent {
...
export class PayrollEntryItemTypeRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(PayrollEntryItemTypeRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: PayrollEntryItemTypeEntityOptions = {}): PayrollEntryItemTypeEntity | undefined {
    ...
    private async triggerEvent(data: PayrollEntryItemTypeEntityEvent | PayrollEntryItemTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-payrolls-Settings-PayrollEntryItemType", ["trigger"]);
        ...
        producer.topic("codbex-payrolls-Settings-PayrollEntryItemType").send(JSON.stringify(data));
    }
}
